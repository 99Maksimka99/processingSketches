...
class Student():
    ...
    def __init__(self,coll, n, a, u,z):
        self.name=n
        self.group=a
        self.us=u
        self.grades=z
...
def draw():
    ...
    text("There is",coll.name,"which is now in",coll.group,"the group, and its average score",coll.us,"algebra grades",coll.grades)
    

class Student():
    
    def __init__(self, n, a, u,z):
        self.name=n
        self.group=a
        self.us=u
        self.grades=z
